...
import com.nanashe.backend.service.AlternativeSavingService;
...
public class AlternativesKafkaConsumer {
    ...
    private final AlternativeSavingService alternativeSavingService;
    ...
    public void consume(KafkaAlternativesEvent message) {
        ...
        alternativeSavingService.saveAlternatives(message);
    }
}